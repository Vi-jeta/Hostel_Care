...
app.config["MONGO_URI"] = os.environ.get("MONGO_URI") or "mongodb+srv://vijeta:JdGprWgEoFGEccFp@cluster0.ldjdkg2.mongodb.net/hostelcare?retryWrites=true&w=majority&appName=Cluster0"
print("Mongo URI in use:", app.config["MONGO_URI"])
app.config["MONGO_URI"] = "mongodb+srv://vijeta:JdGprWgEoFGEccFp@cluster0.ldjdkg2.mongodb.net/hostelcare?retryWrites=true&w=majority&appName=Cluster0"
...
app.config['MAIL_USERNAME'] = 'sharmavijeta113@gmail.com'
app.config['MAIL_PASSWORD'] = 'lqtc pfcf jntv veiq'  # Use app-specific password if 2FA is on
...
def request_otp():
    ...
    print("Received employee_id:", repr(employee_id)) # new
    ...
    # If role is admin, check employee_id in employees collection
    if role == "admin":
        if not employee_id:
        ...
        if not mongo.db.employees.find_one({"employee_id": employee_id}):
